...
class Register extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    this.validator.validateAll(credentials)
      .then((success) => {
        if (success) {
          this.props.authRegister(credentials);
        }
      });
  }

  render() {
    const { errors, responseErrors, message } = this.state;

    return (
      <>
        <AuthHeader
          title="SKU Generator"
          lead="This system will help you generate the skus easily with one mouse click."
        />
