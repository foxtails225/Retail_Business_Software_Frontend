...
class ToteBagVariant extends React.Component {
  constructor(props) {
    ...
    this.props.listSizes({ type: "toteBags" });
    this.props.listColors({ type: "toteBags" });
  }
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <>
        ...
        <MainHeader name="ToteBag Variant" parentName="Variant" />
        <Container className="mt--6 toteBag-variant-container" fluid>
          <Card style={{ minHeight: "700px" }}>
            <CardBody>
              <Row>
                <Col>
                  <Button
                    className="btn-createtoteBag"
                    color="primary"
                    onClick={() => {
                      this.createToteBag();
                    }}
                  >
                    Create ToteBags Variant
                  </Button>
                  <Modal
                      ...
                      <ModalBody>
                        ...
                        <FormGroup>
                          ...
                          <Input
                            ...
                            required
                            disabled
                            value={modalToteBag.name}
                            placeholder="e.g. ToteBag Name"
                            type="text"
                ...
                <Col>
                  <div className="div-searchbar-createtoteBag">
              ...
              <Row>
                <Col md={12} xl={12}>
                  <div className="div-tbl-toteBagvariant">
